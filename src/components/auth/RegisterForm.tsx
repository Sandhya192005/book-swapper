...
import { Mail, Lock, User, MapPin, Eye, EyeOff, BookOpen, Phone } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Create your account and start exchanging books
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {errors.campus && <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.campus}</p>}
            </div>
